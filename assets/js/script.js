var quizStatus = true; //knowing when the quiz is true and when it is false.
var questionNumber = 0; // This tracks the questions that are being answered.
var answerNumber = 0; // This tracks the next question. 
var score = 0; // Calculates your score. 
var highScore = 50; // Calculates high score. 
...
var answer1BtnEl = document.getElementById('answer1'); // Start Quiz button answer 1 
var answer2BtnEl = document.getElementById('answer2'); // Start Quiz button answer 2
var answer3BtnEl = document.getElementById('answer3'); // Start Quiz button answer 3
var answer4BtnEl = document.getElementById('answer4'); // Start Quiz button Answer 4
var submitScoreEl = document.getElementById('submitScore'); // Start Quiz button submit score 
var questionsEl = document.getElementById('questions'); // Questions
var htmlTimeLeft = document.getElementById('timeLeft'); // Timer 
var answerCorrectWrong = document.getElementById('answerCorrectWrong'); // Display correct or wrong
var questionDisplayEl = document.createElement("questionDisplay"); // Display Question
var finalScoreDisplayEl = document.createElement("finalScoreDisplay"); // Display the final score 
...
var questionsObject = { // has the correct answers.
    correct: { 
...
viewHighScoresBtnEl.addEventListener("click", function() { // high scores is given
...
submitScoreEl.addEventListener("click", function() { // Submit high scores
    ...
    value = [quizUserDetails,highScore] // Create a valid array 
    ...
    for (var i=0; i < localStorage.length; i++){
        ...
        // User added if high score is greater then thhe score alresdy there. 
...
startQuizBtnEl.addEventListener("click", function() {
    ...
    var timeInterval = setInterval(function() {
        ...
        if (score === 1){ // For any wrong answer, take away a point
            highScore -= 10;
        }
        ...
        if(timeLeft >= 1 && finalAnswerCheck !== 1) {
            ...
            questionDisplay.style.display= ""; // questions are being displayed 
            answer1BtnEl.style.display = ""; // options are displayed
            ...
            answer1BtnEl.addEventListener("click", function() {
                ...
                if (questionDisplay.textContent === "The condition statement if/else is enclosed with the following:" && answer1BtnEl.textContent === "Parentheses") {
                    ...
                    //Assign correct or wrong answer when answered 
                    ...
                    switch(answer1BtnEl.textContent) {
                        ...
                        case "Commas":
                            ...
                            answer4BtnEl.style.display = 'none';
                            answerCorrectWrong.style.display='none'; 
                            startQuizBtnEl.style.display = 'none'; // Remove Start Quiz 
                            questionDisplay.textContent = "You have finished the quiz!";
                            finalScoreDisplay.style.display = ""; // Display for final score
                            enterInitials.style.display = ""; // Display Message Enter initials
                            enterInitialsTextArea.style.display="";  // User score is submitted 
                            finalAnswerCheck = 1; // Final answer 
                            lastQuestionWrong();
            ...
            answer4BtnEl.addEventListener("click", function() {
                ...
                if (questionDisplay.textContent === "Arrays can be used to store the following" && answer4BtnEl.textContent === "All of the above") {
                    console.log("Correct") //Game is over after question 4 // Move to the next question
                    questionNumber = 3; // Move to the next question
                    answerNumber = 2;
                    answerCorrectWrong.style.display=""; // Enables text content on correct and wrong answers
                    answerCorrectWrong.textContent = "Correct!"
                    ...
                    switch(answer4BtnEl.textContent) {
                        ...
                        case "Parentheses":
                            ...
                            answerCorrectWrong.style.display='none'; 
                            startQuizBtnEl.style.display = 'none'; 
                            questionDisplayEl.textContent = "You have finished the quiz!";
